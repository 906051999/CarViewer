<template>
    <div id="box" style="min-width: 1800px; height: 900px">
  ...
  onMounted(async () => {
    ...
    const gfxOptions = {
      ...
      glslangUrl: 'playcanvas/src/lib/glslang/glslang.js',
      twgslUrl: 'playcanvas/src/lib/twgsl/twgsl.js',
    ...
    createOptions.keyboard = new pc.Keyboard(document.getElementById('box'))
    ...
    app.on('update', function (dt) {
      ...
      app.root
        ...
        .forEach(function (/** @type {pc.RigidBodyComponent} */ body) {
          body.entity
            .findComponents('render')
            .forEach(function (/** @type {pc.RenderComponent} */ render) {
